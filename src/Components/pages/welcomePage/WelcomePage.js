    ...
    <div className="flex min-h-screen w-screen flex-col bg-gradient-to-b from-sky-50 via-white to-indigo-50">
      ...
      <main className="flex flex-1 flex-col items-center px-4 pb-10 pt-10 sm:px-6 lg:px-8">
        ...
        <section className="flex w-full max-w-5xl flex-col items-center rounded-3xl bg-white/80 p-6 ring-1 ring-black/5 backdrop-blur-sm sm:p-10">
          ...
          {/* Short tagline */}
          <p
            className="max-w-xl text-center text-xs font-medium
                text-transparent bg-clip-text
                bg-gradient-to-r from-slate-500 via-slate-700 to-slate-500
               italic tracking-wide
               line-clamp-2"
          >
            “A digital gateway that exhibits CSIR’s innovations into accessible knowledge
            from lab to lab enabling industry, government, and citizens to explore,
