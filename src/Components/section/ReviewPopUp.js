...
// const ReviewPopup = ({ isOpen, onClose, technologyRefNo }) => {
...
//   // ================= FETCH ALL SECTIONS =================
//   useEffect(() => {
//     if (!isOpen || !technologyRefNo) return;
...
//           axios.get(`/api/section-one/${technologyRefNo}`).catch(() => null),
//           axios.get(`/api/section-two/${technologyRefNo}`).catch(() => null),
//           axios.get(`/api/section-three/${technologyRefNo}`).catch(() => []),
//           axios.get(`/api/section-four/${technologyRefNo}`).catch(() => []),
//         ]);

//         setSectionOneData(s1?.data || null);
//         setSectionTwoData(s2?.data || null);
//         setSectionThreeData(s3?.data || []);
//         setSectionFourData(s4?.data || []);
//       } catch (err) {
//         console.error("Review fetch failed:", err);
//         setFetchError("Failed to load review data.");
//       } finally {
//         setIsLoading(false);
//       }
//     };
...
//       text: "This will finalize all sections.",
//       icon: "warning",
...
//     }).then((res) => {
//       if (res.isConfirmed) {
//         Swal.fire("Submitted!", "Technology submitted successfully.", "success")
...
//         {/* Header */}
//         <div className="sticky top-0 flex justify-between items-center border-b px-6 py-4 bg-white">
//           <h2 className="text-lg font-bold">
//             Review Technology <span className="text-sm text-gray-500">(TRN: {technologyRefNo})</span>
//           </h2>
...
//                     <h3 className="font-semibold text-indigo-700">Section 1: Key Details</h3>
//                     <button onClick={() => goToEdit("/sectionOne")} className="text-sm text-indigo-600">Edit</button>
//                   </div>
//                   <p><b>Name:</b> {displayValue(sectionOneData.nameTechnology)}</p>
//                   <p><b>TRL:</b> {displayValue(sectionOneData.technologyLevel)}</p>
//                 </div>
//               )}
...
//                 <div className="border rounded-xl p-4">
//                   <div className="flex justify-between mb-2">
//                     <h3 className="font-semibold text-indigo-700">Section 2: Team</h3>
//                     <button onClick={() => goToEdit("/sectionTwo")} className="text-sm text-indigo-600">Edit</button>
//                   </div>
//                   <p><b>PI:</b> {displayValue(sectionTwoData.principalInvestigatorName)}</p>
//                 </div>
//               )}
...
//                     Section 3: Licensees ({sectionThreeData.length})
//                   </h3>
//                   <button onClick={() => goToEdit("/sectionThree")} className="text-sm text-indigo-600">Edit</button>
//                 </div>
//                 {sectionThreeData.map((lic, i) => (
//                   <p key={i}>
//                     {i + 1}. {lic.licenseName} – {formatCurrency(lic.totalLicenseFee)}
//                   </p>
//                 ))}
//               </div>
...
//                 <div className="flex justify-between mb-2">
//                   <h3 className="font-semibold text-indigo-700">
//                     Section 4: Deployments ({sectionFourData.length})
//                   </h3>
//                   <button onClick={() => goToEdit("/sectionFour")} className="text-sm text-indigo-600">Edit</button>
//                 </div>
//                 {sectionFourData.map((dep, i) => (
//                   <p key={i}>
//                     {i + 1}. {dep.clientName} – {dep.city},{" "}
//                     {countryOptions.find(c => c.value === dep.country)?.label || "N/A"}
//                   </p>
//                 ))}
//               </div>
//             </>
...
//         {/* Footer */}
//         <div className="sticky bottom-0 flex justify-end gap-3 border-t px-6 py-4 bg-gray-50">
